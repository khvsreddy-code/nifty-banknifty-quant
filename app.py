...
def build_option_df(chain):
    rows=[]
    for x in chain:
        strike=float(x.get("strike_price",np.nan))
        ...
        rows.append({
            "strike":strike,
            "ce_ltp":float(cm.get("ltp") or 0), "ce_oi":float(cm.get("oi") or 0),
            "ce_prev_oi":float(cm.get("prev_oi") or 0), "ce_vol":float(cm.get("volume") or 0),
            "ce_close":float(cm.get("close_price") or 0), "ce_iv":float(cg.get("iv") or 0),
            "pe_ltp":float(pm.get("ltp") or 0), "pe_oi":float(pm.get("oi") or 0),
            "pe_prev_oi":float(pm.get("prev_oi") or 0), "pe_vol":float(pm.get("volume") or 0),
            "pe_close":float(pm.get("close_price") or 0), "pe_iv":float(pg.get("iv") or 0),
            "ce_doi":float(cm.get("oi") or 0)-float(cm.get("prev_oi") or 0),
            "pe_doi":float(pm.get("oi") or 0)-float(pm.get("prev_oi") or 0),
            "ce_prem_chg":(float(cm.get("ltp") or 0)/float(cm.get("close_price") or 0)-1)*100 if cm.get("close_price") else 0,
            "pe_prem_chg":(float(pm.get("ltp") or 0)/float(pm.get("close_price") or 0)-1)*100 if pm.get("close_price") else 0,
        })
